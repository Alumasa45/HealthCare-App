              ...
              <CardContent className="space-y-4">
                {loading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <FormLabel htmlFor="Insurance_Provider">Insurance Provider</FormLabel>
                      <Input 
                    ...
                    <div>
                      <FormLabel htmlFor="Insurance_Policy_Number">Policy Number</FormLabel>
                      <Input 
                  ...
                  <div className="text-center py-4">No patient data available</div>
                )}
              </CardContent>
            </Card>
          </TabsContent>
